 ...
 * ============================================================
 * `reveal_and_execute` no longer takes `meta_hash` -- the H2 fix derives the
 * execution binding on-chain from (recipient, amount), so a keeper cannot
 * substitute their own recipient.
 *
